...
class TailedRCNN(GeneralizedRCNN):
    ...
    def from_config(cls, cfg):
        ...
        if cfg.MODEL.FUSION_MODULE.TYPE == "Concatenation":
            heads_input_dim = roi_feature_dim + physics_fan_feature_dim
        else:
            heads_input_dim = physics_fan_feature_dim

        # The input dimension for the physics heads is determined by the fusion module's output size
        heads = build_physics_heads(cfg, input_dim=heads_input_dim)
