...
class WeightedFastRCNNOutputLayers(nn.Module):
    """
    ...
    def __init__(
        ...
        *,
        ...
        self.mcs_cls_weight = mcs_cls_weight
    ...
    def from_config(cls, cfg, input_shape):
        return {
            ...
            "mcs_cls_weight"            : cfg.MODEL.ROI_BOX_HEAD.MCS_CLS_WEIGHT,
            # fmt: on
        }
    ...
    def losses(self, predictions, proposals):
        ...
        if self.use_sigmoid_ce:
            ...
            # Loss weight 
            class_weights = torch.ones(self.num_classes + 1, device=gt_classes.device) # shape (K+1,)
            MCS_CLASS_ID = 2
            class_weights[MCS_CLASS_ID] = self.mcs_cls_weight
