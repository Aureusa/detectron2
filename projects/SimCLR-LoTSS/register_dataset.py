...
logger = logging.getLogger("SimCLR-LoTSS.register_dataset")
...
def main(cfg_filepath: str = "/home/s4861264/detectron2/projects/LoTSS-GRG-detect/configs/dataset_configs/dataset_b2s_masked_rcnn.yaml"):
